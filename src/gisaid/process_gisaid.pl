...
my $USAGE = "$0 [options] input_metadata.tar.xz output_sequences.tar.xz output_metadata.tsv output_sequences.fasta.gz
...
sub read_metadata {
	...
	die "bad line $line (expected 22 columns)" unless @parts == 22;  # check that we have 22 columns
